...
export function useCalendarData(boxId, userId) {
  ...
  // Utilisé par WeekStrip pour recharger le bon mois quand on swipe vers une
  // semaine qui n'est plus couverte par la plage déjà chargée.
  ...
  return {
    ...
    goToMonth, goToday, goToDate, reload: load,
  }
}
